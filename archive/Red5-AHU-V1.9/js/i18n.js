...
(function(){
  ...
  var D = {
    ...
    export_collector_config: ['Pick master collector_config.json, update this floor AHUs, download full master','选择主 collector_config.json，更新本楼层 AHU 后下载完整主文件','選擇主 collector_config.json，更新本樓層 AHU 後下載完整主檔','マスター collector_config.json を選び、このフロアのAHUを更新して全体をDL','master collector_config.json 선택 → 현재 층 AHU 갱신 → 전체 다운로드'],
    export_collector_config_short: ['Export Master','导出主配置','匯出主配置','Master出力','Master 내보내기'],
