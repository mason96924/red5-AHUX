...
- Copy `/app/archive/Red5-AHU-V2.0/dashboard.html`, `equipment_mapper.html`, all `js/*`, all `*.md` docs into Emergent's `/app/frontend/public/`.
...
*Document created 2026-02-13. Lives at `/app/archive/Red5-AHU-V2.0/WEB_HOSTING_GUIDE.md`. Companion to `VERSION.md` (version split rationale) and the V1.9 `psychrometric_design_workflow.md` (workflow context).*
