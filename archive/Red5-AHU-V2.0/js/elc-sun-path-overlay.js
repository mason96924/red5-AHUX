...
(function (global) {
  ...
  function paintElcSunPath(ctx, opts) {
    ...
    /* Horizon (u=0) is only the floor rose. Altitude lifts screen-up
       (0, -1) out of that isometric plane — not along a cardinal or
       rotate(east,90°), which folds the bowl onto W/E/N/S. */
  ...
  global.ElcSunPathControls = function ElcSunPathControls(props) {
    ...
    const hostPin = !props.compact && !!props.hostPinned;
    return React.createElement('div', {
  ...
  global.ElcSunPathLive = function ElcSunPathLive(props) {
    ...
    const hideChrome = !!(props && props.hostChrome === false);
    const controls = hideChrome ? null : React.createElement(global.ElcSunPathControls, {
      key: 'ctrl',
