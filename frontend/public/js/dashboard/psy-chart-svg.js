        ...
        return (
            <div data-testid="psy-axis-prop-chips"
                ...
                <div className="absolute flex flex-wrap justify-end gap-1 pointer-events-auto"
                     style={{ left: pad.left + gridWidth * 0.55, right: Math.max(8, pad.right - 76), top: pad.top + gridHeight + 66, maxHeight: 40 }}>
                    <div className="ml-auto flex flex-wrap justify-end gap-1 items-center">
                        {chips.map(c => (
                            <span key={c.key}
                                  title={c.title}
