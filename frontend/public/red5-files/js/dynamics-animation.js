...
function initDynamicsAnimation(container, isDark, opts) {
    ...
    function render() {
        ...
        diagLine1.setAttribute('x1',sxI);diagLine1.setAttribute('y1',syI);diagLine1.setAttribute('x2',xNE);diagLine1.setAttribute('y2',yNE);
        diagLine2.setAttribute('x1',sxI);diagLine2.setAttribute('y1',syI);diagLine2.setAttribute('x2',xSW);diagLine2.setAttribute('y2',ySW);
