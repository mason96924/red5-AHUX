...
> ```bash
> cd ~/red5-studio
> git checkout -- archive/Red5-AHU-V1.9/repair_manifest.json
...
**Files touched** (Triple Parity):
  ...
  * `archive/Red5-AHU-V1.9/**` and `archive/Red5-AHU-V2.0/**`
    — byte-identical mirrors of all four artefacts above.
  * `archive/Red5-AHU-V1.9/repair_manifest.json` — regenerated
    (50 entries; hash of two artefacts changed).
  * `archive/Red5-AHU-V1.9/red5_bundle.zip` — rebuilt.
...
**Delivered**:
  ...
  * **Universal HTML cache opt-out**:
    ...
    - `bootstrap_controllers.sh` mirror preflight -- refuses to push
      to V1.9 controllers if any `archive/Red5-AHU-V1.9/*.html` is
...
**Changes**:
  ...
  * Synced to `archive/Red5-AHU-V1.9/dashboard.compiled.js` and
...
**New artefacts**:
  * `archive/Red5-AHU-V1.9/repair_manifest.json` — the canonical
...
**Wired into CI**:
  * `.emergent/pre-commit-parity.sh` now ALSO runs
    ...
    `archive/Red5-AHU-V1.9/` is staged.  Commits whose manifest
...
**Fix in `archive/Red5-AHU-V1.9/landing.html`**:
...
**Fixes in `archive/Red5-AHU-V1.9/update.html`**:
...
**Fixes in `archive/Red5-AHU-V1.9/upload_service.py`**:
...
**Files**
  ...
  * `archive/Red5-AHU-V1.9/{dashboard.compiled.js,dashboard.html,js/dashboard/app.js}` (mirrored)
  * `archive/Red5-AHU-V2.0/{dashboard.compiled.js,dashboard.html,js/dashboard/app.js}` (mirrored)
...
- 3-way parity locked across `frontend/public/`,
  `archive/Red5-AHU-V1.9/`, `archive/Red5-AHU-V2.0/`.
...
`/app/frontend/public/` ≡ `/app/archive/Red5-AHU-V1.9/` ≡ `/app/archive/Red5-AHU-V2.0/`.
...
2. **`archive/Red5-AHU-V1.9/app.py`** — same helper added in `serve_asset` and `api_thumb`. Mirrored to `archive/Red5-AHU-V2.0/app.py` (`md5sum` locked).
...
- `/app/archive/Red5-AHU-V1.9/tests/test_translation_kit.py`
...
- Mirrored identically to all three parity copies: `Red5-AHU-V1.9/`, `Red5-AHU-V2.0/`, `frontend/public/` (md5 verified).
...
Added `archive/Red5-AHU-V1.9/tests/` with pytest assertions covering each regression hit on 2026-05-27.
...
**Fix shipped**:
- Added stacked Flask route aliases in both `archive/Red5-AHU-V1.9/app.py` and `archive/Red5-AHU-V2.0/app.py`:
...
- Mirrored to all three copies: `archive/Red5-AHU-V1.9/`, `archive/Red5-AHU-V2.0/`, `frontend/public/`.
...
- `archive/Red5-AHU-V1.9/js/docs_index.js` — identical mirror.
- `archive/Red5-AHU-V1.9/dashboard.html` — identical mirror.
- `archive/Red5-AHU-V1.9/g36_reset.md` — already mirrored in L.7.
- `archive/Red5-AHU-V1.9/docs/` (new dir) — full mirror.
- `archive/Red5-AHU-V1.9/app.py` — `_STANDARDS_CATALOG` + Flask `/api/standards*` routes.
...
Comprehensive 275-line technical document at `/app/g36_reset.md` (mirrored to `/app/archive/Red5-AHU-V1.9/g36_reset.md`) covering:
...
- `archive/Red5-AHU-V1.9/weather_service.py` — mirror of `default` schema + clearing logic.
- `archive/Red5-AHU-V1.9/dashboard.html` — identical mirror of pin UI.
- `archive/Red5-AHU-V1.9/js/psy-3d-engine.js` — identical mirror of pin button.
- `g36_reset.md` (new) — V2.0 root.
- `archive/Red5-AHU-V1.9/g36_reset.md` (new) — V1.9 controller copy.
...
- `archive/Red5-AHU-V1.9/js/psy-3d-engine.js` — identical mirror.
- `archive/Red5-AHU-V1.9/dashboard.html` — identical mirror.
- `archive/Red5-AHU-V1.9/psy_3d.html` — identical mirror.
...
**3-tier weather-history proxy** (`/api/weather-proxy`) — implemented in both V1.9 (`/app/archive/Red5-AHU-V1.9/app.py`) and V2.0 (`/app/backend/server.py`):
...
- `archive/Red5-AHU-V1.9/app.py` — mirrors V2.0: +35 lines (`datetime` import, `_LAST_WEATHER_SOURCE`, `_mark_weather_source`, `/api/weather-health` route, calls in each tier).
- `frontend/public/dashboard.html` — +50 lines: `v2-weather-dot` span in the auth pill + polling IIFE.
- `archive/Red5-AHU-V1.9/dashboard.html` — +60 lines: standalone `v19-weather-pill` floating top-right + polling IIFE.
...
### VAV chart-dot visual parity fix (`frontend/public/dashboard.html`, mirrored in `archive/Red5-AHU-V1.9/dashboard.html`)
...
### Markov drift layer for simulator (`backend/server.py`, mirrored in `archive/Red5-AHU-V1.9/telemetry_service.py`)
...
### V1.9 root cause + fix (`archive/Red5-AHU-V1.9/telemetry_service.py`)
...
- Applied identically to V2.0 (`frontend/public/`) and V1.9 (`archive/Red5-AHU-V1.9/`).
...
- `archive/Red5-AHU-V1.9/js/psychrometric.js`, `archive/Red5-AHU-V1.9/dashboard.html` (V1.9)
...
### Fix (`archive/Red5-AHU-V1.9/dashboard.html`)
...
### Diff method
```
grep -rhE "add_url_rule|@app\.route" /app/archive/Red5-AHU-V1.9/*.py
...
- **`/app/archive/Red5-AHU-V1.9/`** — **Controller Edition** (production at `219.79.12.63:5001`). Frozen baseline; bug-fix only. All work in this PRD before 2026-02-13 refers to this version.
- **`/app/archive/Red5-AHU-V2.0/`** — **Web Hosted Edition** (greenfield, just forked). Multi-tenant SaaS target. Migration plan: `Red5-AHU-V2.0/WEB_HOSTING_GUIDE.md`. Version-split rationale: `Red5-AHU-V2.0/VERSION.md`. Phase 1 = Demo Mode on Emergent (1-2 days).
...
- **P4** — Workspace cleanup (`/app/archive/Red5-AHU-V1.9/` dedupe + restructure)
...
- [x] **Forked V1.8 → V1.9** at `/app/archive/Red5-AHU-V1.9/`. Flask `/root/data` symlink repointed to V1.9. V1.8 frozen as reference.
...
### Tests (`/app/archive/Red5-AHU-V1.9/tests/test_streaming_upload.py`)
...
- [x] **Regression tests**: `/app/archive/Red5-AHU-V1.9/tests/test_strategy_math.js` — 7 pass / 0 fail. Locks in (a) bandDyn ≠ dyn during heat waves, (b) Opt-SA is the lowest curve when SA is inside the comfort envelope, (c) Opt-SA → 0 when OA fully inside `[optMinH, optMaxH]`, (d) clamp respects envelope bounds in cold weather.
...
### Fix
- Resynced 7 files from `archive/Red5-AHU-V1.9/` → `red5_bundle.zip`.
...
### Reproducibility
- Build: `cd /app/archive/Red5-AHU-V1.9 && python build_bundle.py`
...
**File:** `/app/archive/Red5-AHU-V1.9/collector.py` (912 lines, unchanged length).
...
**File:** `/app/archive/Red5-AHU-V1.9/equipment_mapper.html` (1 function rewritten, lines 1317–1359).
...
**Files:**
- `/app/archive/Red5-AHU-V1.9/js/psychrometric.js` (+1 helper, +1 token map)
- `/app/archive/Red5-AHU-V1.9/dashboard.html` (refactored VAV-table dot logic + chart indicator tooltip)
- `/app/archive/Red5-AHU-V1.9/tests/test_givoni_tier_resolver.js` (NEW — 16 assertions)
...
python3 tests/dryrun_clone_bundle.py --data-root /app/archive/Red5-AHU-V1.9
```
...
## Translations + popup
- Added JA / ZH-CN / ZH-TW translations for `erv_band_shift_insight.md` and `psychrometric_design_workflow.md` (6 new files).  Live in `/app/frontend/public/assets/` and mirrored to `/app/archive/Red5-AHU-V1.9/` (both root + `docs/`).
...
- `/app/archive/Red5-AHU-V1.9/dashboard.html` (mirrored)
- `/app/archive/Red5-AHU-V2.0/dashboard.html` (mirrored)
- `/app/archive/Red5-AHU-V1.9/red5_bundle.zip` (rebuilt, 2121.8 KB)
...
- Parity locked: md5 identical across /app/frontend/public/, /app/archive/Red5-AHU-V1.9/, /app/archive/Red5-AHU-V2.0/.
...
- `/app/archive/Red5-AHU-V1.9/dashboard.html` (mirrored)
- `/app/archive/Red5-AHU-V1.9/mobile_mockup.html` (mirrored)
- `/app/archive/Red5-AHU-V2.0/dashboard.html` (mirrored)
- `/app/archive/Red5-AHU-V2.0/mobile_mockup.html` (mirrored)
- `/app/archive/Red5-AHU-V1.9/red5_bundle.zip` (rebuilt)
...
- Flask `/mobile` + `/mobile_mockup.html` routes added in `/app/archive/Red5-AHU-V1.9/app.py` and `/app/archive/Red5-AHU-V2.0/app.py`.
...
- Mirrored to `/app/archive/Red5-AHU-V1.9/setup_walk_mockup.html` and `/app/archive/Red5-AHU-V2.0/setup_walk_mockup.html`
...
Mirror in `/app/archive/Red5-AHU-V2.0/src/pages/LandingPage.jsx` (md5sum OK).
...
- Mirrored to `/app/archive/Red5-AHU-V1.9/` and `/app/archive/Red5-AHU-V2.0/` (md5 = fae4ee0471f7a790ffeb00b3b8dd162a, all three identical).
...
**Fix** in `/app/archive/Red5-AHU-V1.9/telemetry_service.py`:
...
**Boot integration** (`/app/archive/Red5-AHU-V1.9/app.py` just before `app.run`):
...
- Skips silently if no `backend/routes/` or `archive/Red5-AHU-V1.9/*.py` files are staged (frontend-only / docs-only commits stay fast).
...
- Regenerated `/app/archive/Red5-AHU-V1.9/repair_manifest.json` (50 entries).
...
**Changes:**
- `archive/Red5-AHU-V1.9/upload_service.py`:
...
- Regenerated `archive/Red5-AHU-V1.9/repair_manifest.json` (50 entries).
