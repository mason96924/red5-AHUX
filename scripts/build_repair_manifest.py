...
EXTRA_ALLOWED_NOT_IN_UI = [
    ...
    # NOTE: V1.9 upload_service.py only accepts 'ui' or 'plugin' kinds in the
    # allow-list. Tagging docs/configs as 'ui' is the only way bootstrap_controllers.sh
    # will accept them. Keep this in mind until upload_service.py is widened.
